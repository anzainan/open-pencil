...
export const panelMessageDefaults = {
  ...
  searchStockPhotos: 'Search Pexels…',
  stockPhotoNoKey: 'Configure an image API key in Settings → Media to search photos.',
  openMediaSettings: 'Open Media settings',
  stockPhotosEmpty: 'No photos found',
  insertPhoto: 'Insert photo',
  stockPhotoOrientation: 'Orientation',
  orientationAll: 'All',
